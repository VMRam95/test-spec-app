...
const Hero: FC<HeroProps> = ({
  ...
  subtitle = "Create stunning websites that capture attention and drive results",
  ctaText = "Get Started",
  ctaUrl = "#contact",
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Decorative elements */}
        <div 
          className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-gray-900 to-transparent dark:from-black"
          aria-hidden="true"
        />
      </div>
